...
from .forms import DishesForm, DishesIconImageForm, TagForm
...
# Address Where All The Temp Icon Are Stored 
TEMP_ICON_IMAGE_NAME = "temp_icon_image.png"

# Function To Get The Location Where Temp Icon Is Store 
