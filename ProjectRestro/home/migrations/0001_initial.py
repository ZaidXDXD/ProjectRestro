# Generated by Django 3.1.6 on 2021-02-17 06:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('major_description', models.CharField(blank=True, max_length=40)),
                ...
                ('secondary_description', models.CharField(blank=True, max_length=40)),
                ...
                ('tertiary_description', models.CharField(blank=True, max_length=40)),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, null=True, unique=True)),
                ('course', models.CharField(choices=[('Beverage', 'Beverage'), ('Starter', 'Starter'), ('MainCourse', 'Main-Course'), ('Dessert', 'Dessert')], max_length=65, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
